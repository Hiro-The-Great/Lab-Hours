...
ggplot(c, aes(month, day, fill= Hours)) + 
  geom_tile() +
  scale_fill_gradient(low="#ed0867", high = "#fdc1d5", na.value="transparent") +
  theme_tufte()+
...
ggplot(a, aes(x=Date, y=sum, colour=Project, fill=Project)) +
  ...
  scale_fill_manual(values=c("#F2C6De", "#dbcdf0", "#c6def1", "#f7d9c4", "#c9e4de", "#faedcb")) +
  scale_color_manual(values=c("#F2C6De", "#dbcdf0", "#c6def1", "#f7d9c4", "#c9e4de", "#faedcb")) +
  theme_classic() +
  theme(plot.background = element_rect(fill = "#f6f1f7"),
        panel.background = element_rect(fill = "#f6f1f7"),
...
ggplot(task_data, aes(x = Project, y = Percentage, fill = Task, label=Task)) +
  ...
  scale_fill_manual(values=c("#f29982", "#fed87e", "#f6b9b1", "#95cfc0", "#cbb7db", "#74be97","#99a8ca", "#f090ba", "#e1c2dd", "#fcdbab", "#9ed1e8", "#ddcbb4", "#c2dfc9", "#CCDBE9")) +
  scale_color_manual(values=c("#f29982", "#fed87e", "#f6b9b1", "#95cfc0", "#cbb7db", "#74be97","#99a8ca", "#f090ba", "#e1c2dd", "#fcdbab", "#9ed1e8", "#ddcbb4", "#c2dfc9","#CCDBE9")) +
